...
router.route('/')
  .post(validator.createProduct, validateRequest, protect, adminMiddleware , createProduct)
...
router
  ...
  .put(validator.updateProduct, validateRequest, protect, adminMiddleware, updateProduct)
  .delete(validator.deleteProduct, validateRequest, protect, adminMiddleware, deleteProduct);
